            ...
            public:
                ...
                bool timed_wait(
                    ...
                    return timed_wait(lock,
                                      RobustInterprocessCondition::steady_clock_time_point_to_ptime(max_blocking_time));
                }
            ...
            private:
                ...
                inline void do_wait(
...

                    {
                        ...
                        //!https://github.com/boostorg/interprocess/issues/109
                        //!https://github.com/boostorg/interprocess/issues/65
                        ...
                        auto timeout = boost::posix_time::ptime(boost::posix_time::pos_infin);
//                        auto timeout=boost::get_system_time()+ boost::posix_time::seconds(1);


                        semaphores_pool_[sem_index].sem.timed_wait(timeout);
                    }
